                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{route('admin.update',['id' => $admin->id])}}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                <a data-name="{{ $admin->username }}" class="dropdown-item delete-link" data-route="{{route('admin.delete',['id' => $admin->id])}}" ><i class="bx bx-trash me-1"></i> Lock</a>
                            </div>
                          </div>
                        </td>
                      </tr>
