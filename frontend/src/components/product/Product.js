...
export default function Product(props) {
  ...
  const ProductItem = ({id})=>{
    return(
      <NavLink to={`/product-detail/${id}`} className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">Quick View</NavLink>
    );
  }
  return (
    <>
